...
| 文档 | 写什么 |
|---|---|
| README.md（本文件） | 现状、怎么跑、分工、约束、待办、文档去哪找 |
| 架构图.md / 架构说明.md | 五张图 + 关键文件 |
| 工具说明.md | 5 个工具的契约 |
| 实现文档.md | 关键决策、目录、实施步骤 |
| 语义层与提速方案.md | 早期任务分析（历史） |
| 微调方案讨论.md / 微调数据方案.md | 微调该训什么、数据怎么造（历史） |
| 报告技能设计.md | 年度缺陷治理计划报告：流程、口径、改动清单、验收标准（含「实施后的修正」） |
| output/report_skill/ | 计划报告的实测产物：效果报告、两套范围报告、预览页与截图 |
| 构建说明.md | v0.5 草案（历史） |
| 局域网访问说明.md | 给同事的访问地址、放行防火墙、排查 |
| secretary/口径库.md、电力业务口径文档.md、数据地图.md | 知识库内容（已上传百炼） |
| output/ | 测试报告与原始数据（回归报告_v3.md、原话全流程测试_v1.md、全流程检查.md、端到端*、测试报告_v1..v4） |
